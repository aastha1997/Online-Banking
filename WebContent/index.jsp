...
<title>Delhi Central Bank</title>
...
try {
			...
			PreparedStatement ps1=con1.prepareStatement("Select max(accountno) from openaccount");
			...
			PreparedStatement ps=con.prepareStatement("Select * from OPENACCOUNT where accountno='"+accountno+"'");
